...
public class ProductRepository {
	...
	public ProductRepository() {
		...
		Book phone = new Book("P1234", "iPhone 6s", 800000);
		...
		Book notebook = new Book("P1235", "LG PC 그램", 1500000);
		...
		Book tablet = new Book("P1236", "Galaxy Tab S", 900000);
	...
	//상품 상세 정보를 가져오는 메소드 
	public Book getProductById(String productId) {
		Book productById = null;
